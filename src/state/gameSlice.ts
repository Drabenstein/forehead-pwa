...
export const { chooseNQuestions, markAsGoodAnswer, markAsBadAnswer, markAsTimeout, resetAnswerState } = gameSlice.actions;
...
export const selectAnswerState = (state: { game: GameState }) => state.game.answerState;
